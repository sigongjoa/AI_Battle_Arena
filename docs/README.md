...
│   ├── rl_ai_fighter_design_ko.md
│   └── [5개 추가]
│
├── phase2/                      RL 학습 & CI/CD
│   ├── 강화학습_기획서.md
│   ├── ci_cd_and_rl_training_automation_plan.md
│   ├── policy_visualization_design.md
│   └── [7개 추가]
│
├── phase4/                      React 프론트엔드
│   ├── 기획서.md
...
│   └── [5개 추가]
│
├── phase5_battle_rhythm/        리듬 기반 배틀
│   ├── 기획_및_문제_정의서.md
│   ├── 기술_명세서.md
│   └── [8개 추가]
│
├── phase6_character_creation_system/  AI 캐릭터 생성
│   ├── 기획_및_문제_정의서.md
│   ├── 기술_명세서.md
│   └── [5개 추가]
│
├── phase7_ai_driven_qa_and_game_feel_analysis/  AI QA
│   ├── step_0_foundation_setup.md
│   ├── step_1_advanced_simulation_environment.md
│   ├── step_2_log_collector_implementation.md
│   ├── step_3_metric_extractor_implementation.md
│   ├── step_4_qa_evaluator_ai_implementation.md
│   ├── step_5_report_generator_implementation.md
│   ├── step_6_integration_and_testing.md
│   └── [13개 추가]
│
├── protocal_WebRTC/             WebRTC 통신 프로토콜
│   ├── 기획서.md
│   ├── communication_protocol_and_code_spec.md
│   ├── system_flow_use_cases.md
│   └── [13개 추가]
│
